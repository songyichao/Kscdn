...
use Songyichao\Kscnd\Encryption\Handler\EncryptionEO;
...
class Ks3EncryptionClient extends Ks3Client
{
    ...
    public function putObjectByContent($args = [])
    {
        return $this->encryptionHandler->putObjectByContentSecurely($args);
    }

    public function putObjectByFile($args = [])
    {
    ...
    public function initMultipartUpload($args = [])
    {
